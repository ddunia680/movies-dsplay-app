...
function footer(props) {
    return (
        <div className='footer flex flex-col  lg:justify-between lg:flex-row lg:items-center'>
            {/* left side */}
            <div className='flex flex-col basis-[30%] bg-grayish pb-5 pl-5 pr-5 pt-2  xl:pb-40 xl:pl-40 xl:pt-10 xl:pl-40'>
            ...
            {/* Right side */}
            <div className='basis-[30%] bg-grayish pr-5 pt-1 pl-5 xl:pr-10 xl:pt-10 xl:pb-[8.5rem] xl:pr-40'>
                <h2 className='text-lightGray text-4xl py-4 flex flex-row justify-center space-x-2 items-center lx:justify-end'>
